    ...
    <div style={{ fontFamily: 'Arial, sans-serif', padding: '20px' }}>
      ...
      <section style={{ maxWidth: '400px', margin: '0 auto', padding: '20px' }}>
        <form>
          ...
          <input type="password" placeholder="Wachtwoord" required style={inputStyle} />
          <input type="text" placeholder="Adres" required style={inputStyle} />
          <input type="text" placeholder="Specialisatie" required style={inputStyle} />
